...
class ThankyouScreenOneway :  AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // var next_button = view.findViewById<TextView>(R.id.next_button)
        ...
        pref = PrefManager(this@ThankyouScreenOneway)
        ...
        ll_back.setOnClickListener {
            startActivity(Intent(this@ThankyouScreenOneway, DashBoard::class.java))
        }
       ...
       /* next_button.setOnClickListener {
        ...
        book_other.setOnClickListener {
            ...
            startActivity(Intent(this@ThankyouScreenOneway, OneWay_Activity::class.java))
    ...
    override fun onBackPressed() {
        ...
        Toast.makeText(this@ThankyouScreenOneway, "Unable to back your money already deducted", Toast.LENGTH_LONG).show()
    }
