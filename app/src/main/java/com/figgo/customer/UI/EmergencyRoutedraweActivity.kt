                        ...
                        if (response != null) {
                            try {
                                ...
                                if (status.equals("true")) {
                                    ...
                                    dialog.setContentView(R.layout.emergencymapdialog)
...
if(destinationLatitude>=0.000&&destinationLongitude>=0.00) {
    ...
    mMap?.addMarker(
        ...
        mMap?.addMarker(MarkerOptions().position(customerLoc!!).icon(BitmapDescriptorFactory.fromBitmap(smallMarker3)).title("My Location"))
